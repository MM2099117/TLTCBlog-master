    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create(CommentViewModel model, int? id)
        {
            if (ModelState.IsValid)
            {
                ...
                model.Article.Comments.Add(comment);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.CreatorID = new SelectList(db.Users, "Id", "FullName", comment.CreatorID);
            return View(comment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentID,Text,CreatorID")] Comment comment)
        {
            if (ModelState.IsValid)
            {
